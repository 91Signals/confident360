    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          <h1 className="text-2xl font-bold text-white mb-2">Analyze Profile</h1>
          <p className="text-slate-400 mb-6">This is a placeholder page. Soon you will be able to analyze and optimize your LinkedIn profile keywords to align with your portfolio strengths.</p>
